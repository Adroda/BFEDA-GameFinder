...
const generatePlatforms = (platforms) => {
  ...
  platforms.forEach((element) => {
    switch (element.platform.name) {
      case "PC":
        platformsList += `<svg aria-label="PC" class="consoles__logo" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        break;
      case "PlayStation":
        platformsList += `<svg aria-label="Playstation" class="consoles__logo" width="24" height="20" viewBox="0 0 24 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M9.55176 9.53674e-06L9.55176 18.2774L13.3605 19.5885L13.3605 4.26319C13.3605 3.54103 13.6568 3.06155 14.1321 3.22645C14.7535 3.41372 14.8743 4.07895 14.8743 4.79307L14.8743 10.9138C17.245 12.1606 19.1115 10.9131 19.1115 7.62345C19.1115 4.26188 18.0172 2.76435 14.7973 1.56033C13.5273 1.10084 11.1735 0.325457 9.55176 9.53674e-06Z" fill="white"/>
                <path d="M14.3506 16.9129L20.1079 14.3203C20.7592 14.0148 20.8587 13.5998 20.3316 13.3817C19.7962 13.1596 18.8406 13.2232 18.1824 13.5222L14.3506 15.2325V12.5036L14.57 12.412C14.57 12.412 15.6792 11.9148 17.2392 11.7008C18.7962 11.4848 20.7057 11.7289 22.2065 12.4446C23.8971 13.1241 24.0866 14.1153 23.6589 14.8051C23.2249 15.4877 22.1728 15.9815 22.1728 15.9815L14.3506 19.5367" fill="white"/>
                <path d="M1.7099 17.2146C-0.0868735 16.6444 -0.386499 15.4395 0.433179 14.7435C1.18926 14.1079 2.47691 13.6295 2.47691 13.6295L7.79974 11.4675V13.9281L3.97289 15.4908C3.29503 15.767 3.1934 16.1557 3.73939 16.359C4.29514 16.5706 5.28141 16.5137 5.95966 16.2286L7.79974 15.4728V17.6695C7.68114 17.6921 7.54927 17.715 7.42892 17.7384C5.5943 18.0852 3.63971 17.9428 1.7099 17.2146Z" fill="white"/>
        ...
        break;
      case "Xbox":
        platformsList += `<svg aria-label="Xbox" class="consoles__logo" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        break;
      case "Nintendo":
        platformsList += `<svg aria-label="Nintendo" class="consoles__logo" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M14.8842 20H11.8082C11.7298 20 11.667 19.9371 11.667 19.8585V0.125786C11.667 0.0628931 11.7141 0 11.7925 0H14.8842C17.7091 0 20.0003 2.2956 20.0003 5.12579V14.8742C20.0003 17.7044 17.7091 20 14.8842 20ZM17.6305 11.0063C17.6305 9.88994 16.7203 8.97799 15.6061 8.97799C14.4918 8.97799 13.5973 9.88994 13.5816 11.0063C13.5816 12.1226 14.4918 13.0346 15.6061 13.0346C16.7203 13.0346 17.6305 12.1226 17.6305 11.0063Z" fill="white"/>
                <path d="M3.33301 6.66667C3.33301 7.58333 4.08301 8.33333 4.99967 8.33333C5.91634 8.33333 6.66634 7.58333 6.66634 6.66667C6.66634 5.75 5.91634 5 4.99967 5C4.06912 5 3.33301 5.73611 3.33301 6.66667Z" fill="white"/>
                <path fill-rule="evenodd" clip-rule="evenodd" d="M5.31811 0H9.85318C9.93475 0 10 0.0628931 10 0.141509V19.8585C10 19.9371 9.93475 20 9.85318 20H5.31811C2.38173 20 0 17.7044 0 14.8742V5.12579C0 2.2956 2.38173 0 5.31811 0ZM5.31807 18.3963H8.33602V1.60382H5.31807C4.33928 1.60382 3.42574 1.98117 2.74058 2.64155C2.03912 3.30193 1.66391 4.18243 1.66391 5.12583V14.8743C1.66391 15.8177 2.05543 16.6982 2.74058 17.3585C3.42574 18.0346 4.33928 18.3963 5.31807 18.3963Z" fill="white"/>
                </svg>`;
        break;
      default:
        break;
