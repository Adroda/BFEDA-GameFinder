...
const renderCards = async () => {
    ...
    <img
        ...
        alt="Game Image"
    />
    <div class="card__item card__info">
        <h4 class="info__title noMargin">${element.name}</h4>
        <h4 class="info__number noMargin">#1</h4> <!-- TODO como saco el numero-->
    </div>
    <div class="card__item card__releaseDate">
        ...
        <div class="releaseDate__consoles">
            <svg
                class="consoles__logo"
                width="24"
                height="20"
                viewBox="0 0 24 20"
                fill="none"
    ...
    <div class="card__item card__genres">
        ...
        <p class="genres__list noMargin">${element.genres[0]}</p> <!-- TODO tengo q ver como hacer esto y las imagenes-->
    </div>
    </div>`;
        document
